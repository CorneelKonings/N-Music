...
fun Queue(
    ...
    val sleepTimerRemaining by playerConnection.service.sleepTimer.remainingSeconds.collectAsState()
    val sleepTimerPauseWhenEnd by playerConnection.service.sleepTimer.pauseWhenSongEnd.collectAsState()
    val sleepTimerEnabled = sleepTimerRemaining > 0L || sleepTimerPauseWhenEnd
            ...
            when (playerDesignStyle) {
                PlayerDesignStyle.V2 -> {
                    QueueCollapsedContentV2(
                        ...
                        onSleepTimerClick = {
                            if (sleepTimerEnabled) {
                                playerConnection.service.sleepTimer.stop()
                            } else {
